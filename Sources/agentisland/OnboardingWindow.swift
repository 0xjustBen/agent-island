...
final class OnboardingWindow {
    ...
    private func build() {
        ...
        w.title = "Welcome to AgentIsland"
        w.center()
        ...
        VStack(alignment: .leading, spacing: 16) {
            HStack(spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("AgentIsland").font(.system(size: 22, weight: .bold))
            ...
            row(icon: "antenna.radiowaves.left.and.right", color: .cyan,
                ...
                detail: "/tmp/agentisland.sock — local only, mode 0600. Nothing leaves your Mac.")
            ...
            row(icon: "hand.raised.fill", color: .yellow,
                ...
                detail: "Accessibility (focus terminal window) and Automation > System Events (type the chosen option). AgentIsland will prompt the first time you click an option in the notch.")
